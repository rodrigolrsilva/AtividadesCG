// Hello3D_M5 - Rodrigo Luis Rodrigues da Silva
// Camera em primeira pessoa: movimentacao com WASD, rotacao com mouse
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "M5 - Camera - Rodrigo", nullptr, nullptr);
